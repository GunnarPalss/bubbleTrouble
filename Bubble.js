...
Bubble.prototype.rememberResets = function () {
...
//Bubble.prototype.KEY_THRUST = 'W'.charCodeAt(0);
//Bubble.prototype.KEY_RETRO  = 'S'.charCodeAt(0);
//Bubble.prototype.KEY_LEFT   = 'A'.charCodeAt(0);
//Bubble.prototype.KEY_RIGHT  = 'D'.charCodeAt(0);

Bubble.prototype.KEY_FIRE   = ' '.charCodeAt(0);

// Initial, inheritable, default values
Bubble.prototype.rotation = 0;
Bubble.prototype.cx = 200;
Bubble.prototype.cy = 200;
Bubble.prototype.velX = 5;
Bubble.prototype.velY = 0;
Bubble.prototype.launchVel = 2;
Bubble.prototype.numSubSteps = 1;

// HACKED-IN AUDIO (no preloading)
Bubble.prototype.warpSound = new Audio(
    "sounds/BubbleWarp.ogg");

Bubble.prototype.warp = function () {
...
Bubble.prototype._updateWarp = function (du) {
...
Bubble.prototype._moveToASafePlace = function () {
...
Bubble.prototype.computeSubStep = function (du) {
...
Bubble.prototype.computeThrustMag = function () {
...
Bubble.prototype.applyAccel = function (accelX, accelY, du) {
    ...
    var minY = g_sprites.Bubble.height / 2;
    var maxY = g_canvas.height - minY;

    var minX = g_sprites.Bubble.height / 2;
    var maxX = g_canvas.width - minX;

    // Ignore the bounce if the Bubble is already in
...
Bubble.prototype.maybeFireBullet = function () {
...
Bubble.prototype.takeBulletHit = function () {
    this.warp();
};
...
Bubble.prototype.halt = function () {
    this.velX = 0;
    this.velY = 0;
};
...
Bubble.prototype.updateRotation = function (du) {
